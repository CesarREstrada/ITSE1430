...
namespace Movie.Mvc.Models
{
    ...
    {
        public MovieModel()     // this default consturctor as to be here or it will fail a complie time
        { }

        public MovieModel (Itse1430.MovieLib.Movie item) // was Movie movie
        {
            if (item != null)
            {
                Id = item.Id;
